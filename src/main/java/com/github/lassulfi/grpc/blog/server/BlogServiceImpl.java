...
public class BlogServiceImpl extends BlogServiceGrpc.BlogServiceImplBase {
    ...
    public void updateBlog(UpdateBlogRequest request, StreamObserver<UpdateBlogResponse> responseObserver) {
        ...
        System.out.println("Searching for a blog so we can update id");
        ...
        if (result == null) {
            ...
            System.out.println("Updating blog in database");

            collection.replaceOne(eq("_id", result.getObjectId("_id")), replacement);

            System.out.println("Updated! Sending as a response");
